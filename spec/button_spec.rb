  ...
  describe ":cancel" do
    ...
    describe ":as => :pretty" do
      ...
      describe "with :url Hash" do 
        ...
        before do
          self.stub!(:_routes).and_return(mock('_routes'))
          _routes.stub!(:url_for).with(any_args).and_return('/posts/12') # Rails 3
          controller.stub!(:url_for).with(any_args).and_return('/posts/12') # Rails 2
        end
